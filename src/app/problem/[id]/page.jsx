  ...
  return (
    <div className='w-full px-5 h-screen flex'>
      ...
      <div className='w-1/2 h-screen overflow-scroll py-5 pt-20 px-2'>
        ...
        <p className='mt-3'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vero, quae hic. Porro vel labore perferendis. Totam nihil aspernatur eius quasi.</p>
          ...
          <h3 className='font-bold text-2xl'>Testcases</h3>
          {
            testCases.map((testCase, index) => (
              <div key={index} className=''>
                ...
                <div className='w-full p-5 rounded-xl bg-gray-800 flex items-center text-white'>
                  {testCase.input}
                </div>
